...
# exist in the real CRD (charts/cluster-health-autopilot/templates/
...

{
  ...
  echo "# source: charts/cluster-health-autopilot/templates/crd-driftreport.yaml (Bionic-AI-Solutions/cluster-health-autopilot)"
