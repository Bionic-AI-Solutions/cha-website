...
// Newest release with goreleaser binary assets (all 4 _<os>_<arch>.tar.gz
// assets verified HTTP 200 on 2026-06-11). `releases/latest` resolves to a
// chart-releaser release that carries NO binaries, so ALWAYS pin download
